...
> [!success] Пофиксили
> Если дата открытия этой заметки — 15 октября или позже, значит, **[[tags/omarchy|Omarchy 3.1.0]]** уже вышла в свет, и использует она `walker` версии `2.0.0`. Начиная с этой версии дистрибутива проблема исправлена!
