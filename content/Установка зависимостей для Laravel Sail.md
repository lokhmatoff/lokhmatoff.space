...
Всё ещё рабочий способ (несмотря на его пропажу в [документации](https://laravel.com/docs)) для запуска свежесклонированного проекта через **Laravel Sail** (обёртка над [[Docker]]).
