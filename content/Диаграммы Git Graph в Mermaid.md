...
Данный тип диаграммы позволит нам отобразить в [[MermaidJS|Mermaid]]'е модель ветвления в виде графа [[Git]] для любого репозитория на наше усмотрение. За большей информацией можно обратиться к официальной документации.
