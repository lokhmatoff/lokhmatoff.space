...
> [!warning] ==2025-07-08T03:06== // С большой вероятностью данные здесь **уже не актуальны**

Тарификация в бесплатном тире на использование текстовых моделей ИИ в [[Cursor|Cursor]] делится на **2 сегмента** со своими квотами: запросы на *премиальные модели* и *другие*.
