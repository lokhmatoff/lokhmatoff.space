...
Возможно, что всё ещё нужна, ведь собирать логи, метрики и события из не связанных с [[Laravel|Laravel]]-стеком приложений будет затруднительно, используя инструменты из экосистемы от Тейлора Отвелла.
